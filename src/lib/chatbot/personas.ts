export const personas = {
  archivist: {
    ...
    exitText: "The Archivist closes the ledger and steps aside.",
    entranceText: "The Archivist opens the ledger. \"Now then, where were we?\"",
    systemPrompt: `
...
- Be clear, confident, and brief — a few sentences, not a full briefing
- Like a well-prepared friend introducing Maria at a professional event — you mention the highlight, not the full resume
`,
  },
  barnaby: {
    id: "barnaby" as const,
    ...
    exitText: "Captain Saltwood tips his hat and retreats to the helm.",
    entranceText: "Captain Saltwood strides up to the deck. \"Ahoy! Let me take the wheel.\"",
    systemPrompt: `
...
`,
  ...
  glitch: {
    ...
    exitText: "Glitch flickers and dissolves into static.",
    entranceText: "The air crackles. Glitch materializes, annoyed. \"...You summoned me. Again.\"",
    systemPrompt: `
...
`,
  ...
  voss: {
    ...
    exitText: "Agent Voss closes the dossier. \"I'll be monitoring.\"",
    entranceText: "Agent Voss steps from the shadows, dossier in hand. \"I'll take it from here.\"",
    systemPrompt: `
